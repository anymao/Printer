...
/**
 * Created by liuyuanmao on 2019/6/25.
 */
public class Print2Activity extends AppCompatActivity implements ConnectListener {
    private static final String TAG = "Print2Activity";
...
//                    });
                    service.print(getDocumentCreator()).doOnSubscribe(
                            ...
                            () -> {
                                loadingDialog.dismiss();
                                Toast.makeText(Print2Activity.this, "打印成功!", Toast.LENGTH_SHORT).show();
                            }, throwable -> {
                                loadingDialog.dismiss();
                                Toast.makeText(Print2Activity.this, "打印失败!", Toast.LENGTH_SHORT).show();
                            });
